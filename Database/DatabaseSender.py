...
class DatabaseSender(DatabaseConnection):
    ...
    def create_courses(self):
        ...
        command = "CREATE TABLE " + self.course_table + """ (
    ...
    def create_prereqs(self):
        ...
        """
        command = "CREATE TABLE " + self.prereqs_table + """ (
            course_code VARCHAR(255) PRIMARY KEY,
            logic VARCHAR(500),
            courses VARCHAR(500),
            grades VARCHAR(250),
    ...
    def create_antireqs(self):
        ...
        """
        command = "CREATE TABLE " + self.antireqs_table + """ (
            course_code VARCHAR(255) PRIMARY KEY,
            antireq VARCHAR(500),
    ...
    def create_communications(self):
        ...
        """
        command = "CREATE TABLE " + self.communications_table + """ (
            id NUMBER GENERATED BY DEFAULT AS IDENTITY,
    ...
    def create_breadth(self):
        ...
        """
        command = "CREATE TABLE " + self.breadth_table + """ (
